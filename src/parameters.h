...
const int LED_A = 16;              // DONE LED for A
const int LED_B = 17;              // DONE LED for B
const int LED_C = 18;              // DONE LED for C
const int LED_D = 19;              // DONE LED for D
const int LED_E = 11;              // solution for switching with 20 analog
const int AutoInput_3 = 6;        // Input for Program 3
...
// Syringe Discharge:
byte push_4[] = { 0xCC, 0x00, 0x42, 0x0A, 0x00, 0xDD, 0xF5, 0x01 };
byte push_6[] = { 0xCC, 0x00, 0x42, 0x0E, 0x00, 0xDD, 0xF9, 0x01 };
...
byte push_40[] = { 0xCC, 0x00, 0x42, 0x60, 0x00, 0xDD, 0x4B, 0x02 };
